...
ry_wrt_rcb_x_offset = rbf_wrt_rcb_x_offset - ryb_leg_front_x_offset + rbc_laser_front_x_offset;
ry_wrt_rcb_y_offset = rbf_wrt_rcb_y_offset - ryb_leg_front_left_y_offset + rbc_laser_front_left_y_offset;
ry_wrt_rcb_z_offset = rbf_wrt_rcb_z_offset + rbf_height/2.0 + rbf_compartment_height + rbc_height + ry_height/2.0-3;
